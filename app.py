...
"""
============================================
SAKIL BHAI - RESELLER SYSTEM v9.0 VIP
🔥 FULL ADMIN CONTROL · NO PUBLIC SIGNUP
...
def session_required(f):
    ...
    def decorated(*args, **kwargs):
        if session.get("authenticated"):
            # Check if user is reseller or normal user
            ...
            if role == "reseller":
                ...
                # Normal user or admin: check main expiry
                if is_expired():
                    session.clear()
                    return redirect('https://wa.me/919242428894')
...
def super_admin_required(f):
    ...
    def decorated(*args, **kwargs):
        if not session.get("authenticated"):
            return redirect(url_for('login_page'))
        role = session.get("role")
        if role != "admin" or not session.get("is_super"):
...
<body>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="credit-badge">
                    <i class="fas fa-star"></i> Powered by <strong style="color:#ffd700;">{{ brand_name }}</strong> <i class="fas fa-star"></i>
                </div>
                <img src="{{ logo_url }}" alt="{{ brand_name }}" draggable="false">
    ...
    <div class="footer">
        <div class="container">
            ...
            <div class="copy" style="font-size:5px; margin-top:4px; color:#ffd700; letter-spacing:2px;">
                <i class="fas fa-star"></i> exclusively powered by <strong>{{ brand_name }}</strong> <i class="fas fa-star"></i>
            </div>
            <div class="tricolor"><div class="saffron"></div><div class="white"></div><div class="green"></div></div>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log('🔥 {{ brand_name }} SYSTEM READY');
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card {
            background: rgba(6,6,12,0.92); border: 1px solid rgba(255,215,0,0.05);
        ...
        .stat-box {
            background: rgba(0,0,0,0.15); border: 1px solid rgba(255,215,0,0.05);
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:8px; color:{% if data.expiry and not is_expired(data.expiry) %}#00ff66{% else %}#ff3355{% endif %};">
                                {{ data.expiry[:10] if data.expiry else 'N/A' }}
                            </td>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .footer-text { text-align: center; font-size: 6px; color: #88ddff; letter-spacing: 3px; margin-top: 10px; font-family: 'Orbitron', monospace; }
        .subuser-count {
            font-size: 8px; color: #88ddff; margin-left: 6px;
        }
        @media (max-width: 600px) {
            .header .title h1 { font-size: 15px; }
            .stats { grid-template-columns: repeat(2, 1fr); }
...
<body>
    <div class="container">
        <div class="header">
            <div class="title">
                ...
                <div>
                    ...
                    <div class="sub">full monitoring · reseller control</div>
                </div>
            </div>
            <div class="actions">
                <a href="{{ url_for('user_dashboard') }}"><i class="fas fa-arrow-left"></i> back</a>
        ...
        <!-- All Sub-Users List -->
        <div class="card">
            <div class="card-title"><i class="fas fa-users"></i> all sub-users (global)</div>
            <div class="table-wrap">
                {% if all_subusers %}
                <table>
                    <thead>
...
if __name__ == '__main__':
    ...
    print("="*60)
    print("⚡ SAKIL BHAI - RESELLER SYSTEM v9.0")
    print("🔥 FULL ADMIN CONTROL · NO PUBLIC SIGNUP")
