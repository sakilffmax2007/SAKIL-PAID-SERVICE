...
📍 CIRCULAR MAP VIEW WITH RED BORDER
============================================
"""
...
# ============================================
# USER DASHBOARD - CIRCULAR MAP VIEW
# ============================================
USER_PANEL_HTML = '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        * { -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; }
        ...
        /* ============================================
           CIRCULAR MAP VIEW - PERFECT CIRCLE
           ============================================ */
        .location-section {
            width: 320px;
            height: 320px;
        ...
        .location-section.show {
            display: block;
            animation: circularPop 0.6s cubic-bezier(0.16, 1, 0.3, 1);
        }
        ...
        .location-section.live {
            ...
            box-shadow: 0 0 80px rgba(255, 0, 0, 0.25), inset 0 0 80px rgba(255, 0, 0, 0.08) !important;
        }
        .location-section.area {
            border-color: #ff0000 !important;
            box-shadow: 0 0 60px rgba(255, 0, 0, 0.15), inset 0 0 60px rgba(255, 0, 0, 0.05) !important;
        }
        ...
        @media (max-width: 480px) {
            ...
            .location-section .area-name i { font-size: 12px; }
            .location-section .map-container .location-badge {
                font-size: 7px;
                padding: 4px 12px;
                bottom: 12px;
...
<body>
    ...
    function updateLocationMap(address, lat, lng, type, areaName) {
        ...
        // এলাকার নাম সেট করি - শুধু মেইন এলাকার নাম
        ...
        // এড্রেস দিয়ে সার্চ করি - পুরো এলাকা দেখানোর জন্য Zoom 15
        const cleanAddress = encodeURIComponent(address);
        const mapUrl = `https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=${cleanAddress}&zoom=15&maptype=roadmap`;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        console.log('📍 CIRCULAR MAP VIEW ENABLED');
    });
    </script>
</body>
</html>
...
if __name__ == '__main__':
    ...
    print("📍 CIRCULAR MAP VIEW WITH RED BORDER")
    print("="*60)
